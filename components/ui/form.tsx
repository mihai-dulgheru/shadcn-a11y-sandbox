...
function FormItem({ className, ...props }: React.ComponentProps<"div">) {
  ...
  // Track whether a <FormDescription> is rendered so FormControl only
  // references existing element ids in aria-describedby (avoids broken ARIA
  // references when a field has no description).
...
function FormControl({ ...props }: React.ComponentProps<typeof Slot.Root>) {
  ...
  // Only reference ids whose elements actually exist in the DOM.
  const describedBy =
...
function FormDescription({ className, ...props }: React.ComponentProps<"p">) {
  ...
  // Register presence so FormControl can include this id in aria-describedby.
  React.useEffect(() => {
