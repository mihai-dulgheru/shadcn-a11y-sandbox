...
export default function SettingsPage() {
  ...
  const form = useForm<ProfileValues>({
    ...
    defaultValues: { firstName: "Jane", lastName: "Doe", email: "jane@acme.com" },
    mode: "onBlur",
  })
    ...
    <>
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col gap-8 px-6 py-16">
        <nav aria-label="Breadcrumb">
          ...
          >
            <HugeiconsIcon icon={ArrowLeft01Icon} strokeWidth={2} aria-hidden="true" className="size-4" />
            Back to dashboard
          </Link>
        </nav>
        ...
        <header className="flex items-center gap-4">
          <Avatar size="lg">
            ...
            <AvatarImage src="/avatar.png" alt={`Profile photo of ${fullName}`} />
        ...
        <main id="main-content" tabIndex={-1} className="flex flex-col gap-8 outline-none">
        {/* Personal details ------------------------------------------------ */}
        <section
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4" noValidate>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="h-9 text-sm" autoComplete="given-name" {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="h-9 text-sm" autoComplete="family-name" {...field} />
                      </FormControl>
                      <FormMessage className="text-sm" />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className="h-9 text-sm" type="email" autoComplete="email" {...field} />
                    </FormControl>
              ...
              <div className="flex items-center gap-3">
                <Button type="submit" size="lg" className="h-9 px-4 text-sm" disabled={form.formState.isSubmitting}>
                  Save changes
                </Button>
                {/* Polite live region announces save success to screen readers. */}
                <p role="status" aria-live="polite" className="text-sm text-muted-foreground">
                  {savedAt ? `Changes saved at ${savedAt}.` : <span className="sr-only">No unsaved changes announced.</span>}
                </p>
              </div>
            </form>
          </Form>
        ...
        >
          <div className="flex flex-col gap-1">
            <h2 id="appearance-heading" className="font-heading text-base font-medium">
              Appearance
            </h2>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="min-w-40">
                <DropdownMenuLabel className="text-sm">Interface theme</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuRadioGroup
                  value={theme}
        ...
        >
          <div className="flex flex-col gap-1">
            <h2 id="danger-heading" className="font-heading text-base font-medium text-destructive">
              Delete account
            </h2>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-3">
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="destructive" size="lg" className="h-9 px-4 text-sm">
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  <DialogClose asChild>
                    <Button variant="outline" className="h-9 px-4 text-sm">Cancel</Button>
                  </DialogClose>
                  <DialogClose asChild>
                    <Button variant="destructive" className="h-9 px-4 text-sm" onClick={() => setDeleted(true)}>
            ...
            <p role="status" aria-live="assertive" className="text-sm text-destructive">
              {deleted ? "Account deletion confirmed (demo — no data was removed)." : null}
            </p>
          </div>
        </section>
        </main>
